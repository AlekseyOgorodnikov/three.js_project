...
material.color = new THREE.Color(0x514242);
...
const pointLight3 = new THREE.PointLight(0xa4f09, 0.1);
pointLight3.position.set(1.65, -0.93, -0.22);
...
window.addEventListener('scroll', updateSfere);

function updateSfere(event) {
